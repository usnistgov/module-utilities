...
version-import: ## check version from python import
	-uv run --frozen python -c 'import module_utilities; print(module_utilities.__version__)'
...
install-kernel:  ## install kernel
	...
	--name module-utilities-dev \
    --display-name "Python [venv: module-utilities-dev]"
...
tuna-import	: ## Analyze load time for module
	uv run --frozen python -X importtime -c 'import module_utilities' 2> tuna-loadtime.log

...
.PHONY: .docs-spelling docs-nist-pages docs-open docs-live docs-clean-build docs-linkcheck
...
docs-build docs-release docs-command docs-clean docs-spelling docs-nist-pages docs-live: environment/docs.yaml

...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/module-utilities",
...
htmlhelp_basename = "module_utilitiesdoc"
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(module_utilities.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/module-utilities/blob/{html_context['github_version']}/src/module_utilities/{fn}{linespec}"

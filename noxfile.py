...
def pip_compile(
    ...
    envs_dev_optional = ["test-notebook", "uvxrun-tools", "test-noopt"]
...
nox.session(name="test-noopt", **DEFAULT_KWS)(test_noopt)
nox.session(name="test-noopt-conda", **CONDA_DEFAULT_KWS)(test_noopt)
